...
// `node <script>`.
//
// When running the script with `npx hardhat run <script>` you'll find
// the Hardhat
...
async function main() { // eslint-disable-line require-jsdoc
  ...
  const root =
  '0xe4130558f9ea3fcb929737d7d0feb37fd9db2816990a779b7396c56d144bb57a';
  const freeRoot =
  '0xa74a6335936fbe099b04a7d8b1cb23edc13aabd5a92b8ea1670da711e2acf3bd';
  ...
  const pmvOpt = await PMVOptimized.connect(deployer).deploy(root,
      ...
      freeRoot, provenanceHash, vrfCoordinator, linkToken, keyHash,
